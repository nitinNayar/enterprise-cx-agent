...
def format_decision_trace(session_id: str, events: list) -> str:
    ...
    """
    output = f'<h1 style="color: #111827; margin-bottom: 1rem;">Decision Trace: <code>{session_id}</code></h1>\n\n'
    ...
    for event in deduplicated_events:
        ...
        output += f'<h2 style="color: #111827; margin-top: 1.5rem; margin-bottom: 0.5rem;">Event {event_num}: {event_type}</h2>\n\n'
